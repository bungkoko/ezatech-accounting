				...
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" method="POST" action="<?=base_url()?>index.php/akun/simpan_ubah/" enctype="multipart/form-data">
							<input type="hidden" name="id_lama" value="<?=$akun->id?>">
							<div class="form-group">
								<label for="id" class="col-lg-2 col-sm-2 control-label">ID Akun *</label>
								<div class="col-lg-10">
									<input class="form-control" placeholder="Id Akun" type="number" name="id" value="<?=$akun->id?>" required>
								</div>
							</div>
							<div class="form-group">
								<label for="nama" class="col-lg-2 col-sm-2 control-label">Nama Akun *</label>
								<div class="col-lg-10">
									<input class="form-control" placeholder="Nama Akun" type="text" name="nama" value="<?=$akun->nama?>" required>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-10">
									<label class="label_radio" for="dk1">
										<input name="dk" id="dk1" value="D" type="radio" <?php echo ($akun->debitkredit=='D')?'checked':'' ?>> Debit
									</label>
									<label class="label_radio" for="dk1">
										<input name="dk" id="dk2" value="K" type="radio" <?php echo ($akun->debitkredit=='K')?'checked':'' ?>> Kredit
									</label>
								</div>
							</div>
