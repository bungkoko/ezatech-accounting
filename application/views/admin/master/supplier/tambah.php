			...
			<div class="col-sm-9">
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" method="POST" action="<?=base_url()?>index.php/supplier/simpan_tambah/" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<textarea class="form-control" placeholder="Alamat" name="alamat" rows="10"></textarea>
								</div>
							</div>
							<div class="form-group">
