			...
			<div class="col-sm-9">
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" method="POST" action="<?=base_url()?>index.php/karyawan/simpan_tambah/" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input class="form-control" placeholder="Tempat Lahir" type="text" name="tmp">
								</div>
							</div>
							<div class="form-group">
                    ...
                    <input name="gender" id="gender2" value="Perempuan" type="radio"> Perempuan
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input class="form-control" placeholder="No.Telepon" type="number" name="telp">
								</div>
							</div>
							<div class="form-group">
								<label for="passwd" class="col-lg-2 col-sm-2 control-label">Password *</label>
								<div class="col-lg-10">
