								...
								<tbody>
									...
									<tr>
										...
										<td class="center hidden-phone">
											<a href="<?=base_url()?>index.php/karyawan/passwd/?id=<?=$row->id_pegawai?>" class="btn btn-info btn-xs tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Ubah Password"><i class="fa fa-key"></i></a>
