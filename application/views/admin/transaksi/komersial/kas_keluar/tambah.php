			...
			<div class="col-sm-12">
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" method="POST" action="<?=base_url()?>index.php/kas_keluar/simpan_tambah">
							...
							<table class="table table-condensed">
								...
								<tbody id="table-content">
									<tr class="baris">
										...
										<td>
											<input class="form-control" placeholder="Nominal" type="number" name="nominal[]">
										</td>
									</tr>
								</tbody>
							<tfoot>
			...
			$('#btn-tambah').click(function(ev){
				...
				$('#table-content').append(
					'<tr class="baris">' +
						...
						'<td><input class="form-control" placeholder="Nominal" type="number" name="nominal[]"></td>' +
