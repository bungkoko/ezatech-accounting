...
class Barang extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('admin/master_barang', ["rows"=>$rows]);
	}
	...
	public function form_tambah() {
		...
		$this->load->view('admin/tambah_barang',["kode_baru"=>$kode_baru,"data_kategori"=>$data_kategori,"data_satuan"=>$data_satuan]);		
	}
	...
	public function form_edit() {		
		...
		$this->load->view('admin/edit_barang',["data_barang"=>$data_barang,"data_kategori"=>$data_kategori,"data_satuan"=>$data_satuan]);		
	}
